...
class AppTheme {
  ...
  // Business Clarity Color Palette
  ...
  static const Color surfaceVariantLight =
      Color(0xFFF8FAFC); // Subtle card backgrounds
  ...
  static const Color textSecondaryLight = Color(0xFF475569); // Medium contrast
  static const Color outlineLight = Color(0xFFE2E8F0); // Minimal borders

  static const Color primaryDark = Color(0xFF3B82F6); // Adjusted for dark mode
  static const Color secondaryDark = Color(0xFF94A3B8); // Adjusted slate
  ...
  static const Color accentDark = Color(0xFF10B981); // Adjusted success green
  static const Color warningDark = Color(0xFFF59E0B); // Adjusted amber
  static const Color errorDark = Color(0xFFEF4444); // Adjusted red
  static const Color textPrimaryDark = Color(0xFFF8FAFC); // High contrast light
  static const Color textSecondaryDark =
      Color(0xFFCBD5E1); // Medium contrast light
  static const Color outlineDark = Color(0xFF334155); // Dark borders

  // Shadow colors with primary color at 8% opacity
  static final Color shadowLight = primaryLight.withAlpha(20);
  static final Color shadowDark = primaryDark.withAlpha(20);
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Headline styles - Inter for mobile readability
  ...
  /// Data text style for invoice numbers and calculations
  static TextStyle invoiceDataStyle({
    required bool isLight,
    double fontSize = 16,
